        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                <div class="card-header bg-primary d-sm-flex align-items-center justify-content-between">
                    ...
                    <a class="btn btn-light btn-sm" href="{{ route('admin.rides.create') }}"><i
                        ...
                        <div class="row ml-auto">
                            ...
                            <div class="form-check form-check-inline ml-2">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="ride_type" value="all" checked>
                                    All
                                </label>
                                <label class="form-check-label ml-2">
                                    <input class="form-check-input" type="radio" name="ride_type" value="single"
                                        @if(request('ride_type')=='single' ) checked @endif> Single
                                </label>
                                <label class="form-check-label ml-2">
                                    <input class="form-check-input" type="radio" name="ride_type" value="cyclic"
                                        @if(request('ride_type')=='cyclic' ) checked @endif> Cyclic
                                </label>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        <a class="btn btn-info btn-sm" href="{{ route('admin.rides.show', $ride) }}"><i
                                                class="fas fa-eye"></i></a>
                                        <a class="btn btn-primary btn-sm"
                                            href="{{ route('admin.rides.edit', $ride) }}"><i
