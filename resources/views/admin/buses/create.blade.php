                ...
                <div class="card-header bg-primary d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Bus No" name="bus_no">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Bus Plate" name="bus_plate">
                        </div>
                        <div class="form-group">
                            <input type="number" class="form-control" placeholder="Bus Seat" name="bus_seat">
                        </div>
                    </div>
