        ...
        <div class="col-lg-4">
            <div class="card shadow mb-4">
                <div class="card-header bg-primary d-sm-flex align-items-center justify-content-between">
                    ...
                    <a class="btn btn-light btn-sm" href="{{ route('admin.bus-classes.create') }}"><i class="fas fa-plus"></i></a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                @foreach ($busClasses as $class)
                                    <tr>
                                        <td>{{ $class->name }}</td>
                                        <td class="d-flex justify-content-around">
                                            <a class="btn btn-info btn-sm" href="{{ route('admin.bus-classes.show', $class) }}"><i class="fas fa-eye"></i></a>
