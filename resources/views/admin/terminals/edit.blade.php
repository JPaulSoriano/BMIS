                ...
                <div class="card-header bg-primary d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <input type="text" class="form-control" value="{{ $terminal->terminal_name }}" placeholder="Terminal Name" name="terminal_name">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" value="{{ $terminal->terminal_address }}" placeholder="Terminal Address" name="terminal_address">
                        </div>
                    </div>
